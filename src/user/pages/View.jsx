      ...
      <div className='border p-5 shadow border-gray-200'>
        <div className='md:grid grid-cols-4 gap-x-10'>
          ...
          <div className='col-span-3'>
            ...
            <h3 className='text-xl my-5 text-blue-600'>Author</h3>
            ...
            <div className='flex justify-end'>
              ...
              <button className='text-white p-2 rounded bg-green-900 ms-5'>Buy $ 998</button>
            </div>
          </div>
        </div>
      </div>
      {/* modal */}
      {
        ...
        <div className="flex justify-center items-center min-h-screen scroll-auto">
          <div className="bg-white rounded-2xl md:w-250 w-100">
            {/* modal title */}
            <div className="bg-black text-white p-3 justify-between items-center ">
              <h3>Books Images</h3>
            </div>
            {/* modal body */}
            <div className='relative p-5'>
              <p className='text-blue-600 items-center'><FaCamera className='me-2'/>Camera click of the book in the hand of seller</p>
              {/* books in row & col */}
              <div className='md:flex flex-wrap my-4'>
                <img className='md:w-75 w-25 md:me-2 mb-3 md:mt-0' src="https://cdn.kobo.com/book-images/5967e7fb-edc8-403b-9989-f8aab7b3ed89/1200/1200/False/the-alchemist-38.jpg" alt="book" />
                <img className='md:w-75 w-25 md:me-2 mb-3 md:mt-0' src="https://cdn.kobo.com/book-images/5967e7fb-edc8-403b-9989-f8aab7b3ed89/1200/1200/False/the-alchemist-38.jpg" alt="book" />
                <img className='md:w-75 w-25 md:me-2 mb-3 md:mt-0' src="https://cdn.kobo.com/book-images/5967e7fb-edc8-403b-9989-f8aab7b3ed89/1200/1200/False/the-alchemist-38.jpg" alt="book" />
              </div>
            </div>
