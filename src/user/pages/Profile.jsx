...
function Profile() {
  ...
  return (
    ...
    <div style={{width:'230px',height:'230px',borderRadius:"50%",marginLeft:"70px",marginTop:"-130px"}} className='bg-white p-3'>
      <img width={'200px'} height={'200px'} style={{borderRadius:"50%"}} src={dp==""?"https://cdn.pixabay.com/photo/2020/07/01/12/58/icon-5359553_1280.png":dp.startsWith("https://lh3.googleusercontent.com/")?dp:`${serverURl}/uploads/${dp}`} alt="profile" />
    </div>
    ...
    <p className='text-justify md:px-20 px-5 my-5'>Welcome to my profile. I’m [Name], a [Role/Profession] with experience in [skills/industry]. I’m passionate about solving problems, building meaningful projects, and continuously improving my craft. Lorem ipsum dolor sit, amet consectetur adipisicing elit. Facilis recusandae, ea ab rerum deleniti ullam soluta iusto est temporibus excepturi, tenetur autem inventore quo deserunt in at minima. Itaque, reiciendis!</p>
